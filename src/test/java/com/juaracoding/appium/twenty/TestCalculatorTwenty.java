...
//		delay(3);
//		calculatorTwenty.calcKurang();
//		System.out.println("Hasil " + calculatorTwenty.getTxtResult());
//		assertEquals(calculatorTwenty.getTxtResult(), "= 1");
//	}
//	@Test
//	public void testKali() {
//		delay(3);
//		calculatorTwenty.calcKali();
//		System.out.println("Hasil " + calculatorTwenty.getTxtResult());
//		assertEquals(calculatorTwenty.getTxtResult(), "= 8");
//	}
//	@Test
//	public void testBagi() {
//		delay(3);
//		calculatorTwenty.calcBagi();
//		System.out.println("Hasil " + calculatorTwenty.getTxtResult());
//		assertEquals(calculatorTwenty.getTxtResult(), "= 2");
//	}
